# -*- coding: utf-8 -*-
"""Test két nối gateway (P3): /cai-dat chỉ Owner (giỏ tuyệt đối — Admin ủy quyền
...
def test_owner_luu_vai_llm_va_key_write_only(client):
    ...
    client.post("/cai-dat/llm", data={"vai": "writer", "model": "glm-5",
