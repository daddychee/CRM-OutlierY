...
|---|---|---|---|
| `paper` | Page background, default node fill | `#F7F8FA` (white-smoke) | `#16181C` (jet-black) |
| `paper-2` | Diagram container bg, secondary fill | `#ececec` | `#393e53` |
| `ink` | Primary text, primary stroke | `#16181C` (jet-black) | `#F7F8FA` (white-smoke) |
...
| `accent` | Focal / 1–2 max per diagram | `#2C6FC4` (atomic-tangerine) | `#f08a59` |
...
| `terminal-ink` | `#F7F8FA` | Primary text, primary stroke (same white-smoke as default `ink`) |
